...
*/
			Instructor tempInstructor = new Instructor("stuart", "broad", "sboard@gmail.com");

			InstructorDetail tempInstructorDetail = new InstructorDetail("http://www.sboard@gmail.com",
					"Play Cricket");
			// associate the objects
